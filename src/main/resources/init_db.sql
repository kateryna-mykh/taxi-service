...
-- ----------------------------
-- Proposed set of data to fill DB (Optional)
-- ----------------------------

INSERT INTO drivers (`name`, `licenseNumber`, `login`, `password`) VALUES ('Esme Moyer', '7196-84-9223', 'EsmeMo-dr', 'testdriver1');
INSERT INTO drivers (`name`, `licenseNumber`, `login`, `password`) VALUES ('Rahul Fisher', 'RI115787Z', 'RahulFi-dr', 'testdriver2');
INSERT INTO drivers (`name`, `licenseNumber`, `login`, `password`) VALUES ('Eddie Noble', '8199-16-5937','EddieNo-dr', 'testdriver3');
...
INSERT INTO cars_drivers (`car_id`, `driver_id`) VALUES (1, 3);
INSERT INTO cars_drivers (`car_id`, `driver_id`) VALUES (2, 2);
INSERT INTO cars_drivers (`car_id`, `driver_id`) VALUES (3, 1);
